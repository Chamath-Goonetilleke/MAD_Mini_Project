...
public class ViewActivity extends AppCompatActivity implements LaptopRVAdapter.LaptopClickInterface {
    ...
    private void displayBottomSheet(LaptopRVModel laptopRVModel){
        ...
        TextView Hdd = layout.findViewById(R.id.Hdd);
        TextView Ssd = layout.findViewById(R.id.Ssd);
        Button btnEdit = bottomSheetDialog.findViewById(R.id.btnEdit);
        Button btnView = bottomSheetDialog.findViewById(R.id.btnView);
